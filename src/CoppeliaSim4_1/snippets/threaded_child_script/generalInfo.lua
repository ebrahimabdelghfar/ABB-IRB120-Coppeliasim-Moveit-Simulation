-- A threaded child script is intended to give an object/model a specific simulation
-- functionality. It is only executed while simulation is running. Whenever possible,
-- try to use non-threaded child scripts over threaded child scripts.
--
