...
function createDlg()
    if (not ui) and simBWF.canOpenPropertyDialog() then
        ...
        comboConveyor=simBWF.populateCombobox(ui,10,loc,{},simBWF.getObjectNameOrNone(simBWF.getReferencedObjectHandle(model,simBWF.PALLETIZER_CONVEYOR_REF)),true,{{simBWF.NONE_TEXT,-1}})
